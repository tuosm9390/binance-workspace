          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-start gap-0">
              <span className="text-xl font-bold">
                {binanceSymbol24HTickerPrice?.symbol}
              </span>
            ...
            <div className="flex flex-col items-start gap-0">
              ...
              >
                {Number(binanceSymbol24HTickerPrice?.lastPrice).toLocaleString(
                  "en-US",
                  {
        ...
        <div className="flex items-center gap-4 text-sm h-[40px] w-screen">
          <div className="flex flex-col items-start gap-1">
            ...
            <div className="flex items-start gap-1">
              <span
                className={`text-xs ${
                  binanceSymbol24HTickerPrice?.priceChange >= 0
                    ? "text-[--plus]"
                    : "text-[--minus]"
                }`}
              >
          ...
          <div className="flex flex-col items-start gap-1">
            ...
            <div className="flex items-start gap-1">
              <span className={`text-xs`}>
                {Number(binanceSymbol24HTickerPrice?.highPrice).toLocaleString(
                  "en-US",
                  {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
          ...
          <div className="flex flex-col items-start gap-1">
            ...
            <div className="flex items-start gap-1">
              <span className={`text-xs`}>
                {Number(binanceSymbol24HTickerPrice?.lowPrice).toLocaleString(
                  "en-US",
                  {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
          ...
          <div className="flex flex-col items-start gap-1">
            ...
            <div className="flex items-start">
              <Tag
                text="POW"
                className="text-yellow-500 pr-2 border-r border-r-gray-500 hover:text-yellow-300 cursor-pointer"
              />
              <Tag
                text="Payments"
                className="text-yellow-500 px-2 border-r border-r-gray-500 hover:text-yellow-300 cursor-pointer"
              />
              <Tag
                text="Vol"
                className="text-yellow-500 border-r px-2 border-r-gray-500 hover:text-yellow-300 cursor-pointer"
              />
              <Tag
                text="Hot"
                className="text-yellow-500 border-r px-2 border-r-gray-500 hover:text-yellow-300 cursor-pointer"
              />
              <Tag
                text="Price Protection"
                className="text-yellow-500 pl-2 hover:text-yellow-300 cursor-pointer"
              />
            </div>
          </div>
        </div>
