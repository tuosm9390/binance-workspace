        ...
        <div className="group relative">
          <NavigationItem label={
            ...
            <SubMenu className="min-w-[700px]">
              <div className="flex">
                <SubMenuItem label="Basic" className="w-1/2 p-4 border-gray-700">
                  <MenuItem
                    label="Spot"
